  ...
  return (
    <section className="w-full px-4 py-8 sm:px-6 md:py-10">
      <div className="relative mx-auto w-full max-w-2xl">
        ...
        <div
          className="relative overflow-hidden rounded-3xl border border-black/10  p-6 shadow-[0_24px_70px_rgba(0,0,0,0.10)] backdrop-blur-xl sm:p-8"
          style={{
            boxShadow: "0 24px 70px rgba(var(--color-shadow), 0.12)",
            background: "rgba(var(--color-category))",
          }}
        >
          {/* Header */}
          <div className="flex items-start justify-between gap-4">
            ...
            >
              <span
                className="h-2 w-2 rounded-full"
                style={{ background: "rgb(24 122 214)" }}
              />
              Support
            </div>
          </div>
          ...
          <form onSubmit={handleSubmit} className="mt-8 space-y-5">
            ...
            <div>
              ...
              <select
                ...
                className="mt-2 block w-full rounded-2xl border border-black/10 px-4 py-3 text-sm  outline-none transition focus:border-black/20 focus:bg-white"
                style={{
                  background: "rgb(var(--color-fourthary))",
                  color: "rgb(var(--color-text-reverse))",
                  borderColor: "rgb(var(--color-text-reverse)/0.28)",
                }}
              >
              ...
              <p
                ...
                style={{ color: "rgb(var(--color-text-reverse) / 0.65)" }}
              >
            ...
            <div>
              ...
              <textarea
                ...
                className="mt-2 block w-full resize-none rounded-2xl border border-black/10  px-4 py-3 text-sm outline-none transition placeholder:text-black/35 focus:border-black/20 focus:bg-white"
                style={{
                  background: "rgb(var(--color-fourthary))",
                  color: "rgb(var(--color-text-reverse))",
                  borderColor: "rgb(var(--color-text-reverse)/0.28)",
          ...
          {/* Footer hint */}
          <div
            className="mt-6 flex items-center justify-between text-xs font-medium"
            style={{ color: "rgb(var(--color-text-reverse) / 0.75)" }}
          >
